...
const copy = {
  en: {
    ...
    body: "Modern guitar, ukulele, and electric lessons designed around your goals. Whether you're an absolute beginner, a remote worker seeking an analog reset, or a parent wanting a fun outlet for your child.",
