...
const copy = {
  en: {
    ...
    h1: "Do you want to play the guitar like a pro?",
    ...
    heroLineMobile: "Learn from 10+ years of guitar experience, backed by a psychology degree in how you learn.",
    ...
    <section id="top" className="relative section-auto-height overflow-hidden">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-8 px-6 py-12 sm:gap-12 sm:py-20 lg:grid-cols-2 lg:py-28">
        <Reveal>
          ...
          <h1 className="text-5xl font-extrabold leading-tight tracking-tight text-white sm:text-7xl lg:text-8xl">
            {c.h1}
          </h1>
