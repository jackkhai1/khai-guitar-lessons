...
const copy = {
  en: {
    ...
    h1: "Do you want to play the guitar?",
    ...
    heroLineMobile: "10+ years of guitar experience, backed by a psychology degree in how you learn.",
    trialBtn: "💬 Claim Your Free Trial Lesson on WhatsApp",
    trialBtnMobile: "💬 Claim Free Trial Lesson",
  ...
  return (
    <section id="top" className="relative section-auto-height overflow-hidden">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-8 px-6 py-12 sm:gap-12 sm:py-20 lg:grid-cols-2 lg:py-28">
        <Reveal>
          <p className="mb-4 hidden text-sm font-semibold uppercase tracking-widest text-amber-400 sm:block">
            {c.eyebrow}
          </p>
          <h1 className="text-4xl font-extrabold leading-[1.35] tracking-tight text-white sm:text-6xl lg:text-7xl">
            <span className="box-decoration-clone bg-amber-500 px-2 py-1 text-neutral-950">
              {c.h1}
            </span>
          </h1>
          <p className="mt-4 text-base text-white/70 sm:hidden">{c.heroLineMobile}</p>
