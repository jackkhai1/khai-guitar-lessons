...
const copy = {
  en: {
    ...
    heroLineMobile: (
      <>
        I hold a psychology degree, because most musicians can play, but not
        everyone can teach. Whether it&apos;s you or your child, lessons are
        built around how <em>you</em> learn, not a fixed curriculum.
      </>
    ),
  ...
  zh: {
    ...
    heroLineMobile:
      "我持有心理学学位——因为许多音乐人会演奏，却不是人人都懂得教学。无论是你或你的孩子，课程都会围绕你的学习方式设计，而不是套用固定教材。",
    ...
    <section id="top" className="relative section-auto-height overflow-hidden">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-8 px-6 py-12 sm:gap-12 sm:py-20 lg:grid-cols-2 lg:py-28">
        <Reveal>
          ...
          <h1 className="text-center text-6xl font-extrabold leading-tight tracking-tight text-white sm:text-7xl">
            {c.h1}
          </h1>
